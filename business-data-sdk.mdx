...
The Business data SDK is a thin abstraction over the `/v4/businesses` endpoint, with built-in authentication, retry logic, query composition, and pagination. For the entire suite of examples and tools, you can download them <a href="https://pypi.org/project/datafiniti-sdk/#files" target="_blank" rel="noopener noreferrer">here</a>.&#x20;
...
<CodeGroup default-tab="3" show-lines="true" tabs={["business_geolocation.py","count_query.py","business_paginate.py","business_views.py"]}>
