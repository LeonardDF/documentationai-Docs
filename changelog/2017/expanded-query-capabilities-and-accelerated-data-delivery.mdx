...
* Some field names have changed in order to abide by a consistent naming convention.  See the last note under Data Quality below.  You can view the updated product schema.
