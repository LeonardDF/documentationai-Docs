...
When using the `address` field in your property data query, it defaults to fuzzy matching for exact, full, or partial addresses. Meaning for an address like *1100 Congress Ave., Austin, TX 78701,* the following queries would be acceptable:
