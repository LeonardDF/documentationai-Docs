...
<Columns cols="1">
  <Card title="Properties API reference" href="https://docs.datafiniti.co/reference/properties" icon="database" horizontal="false">
    View the property reference documentation for available endpoints and fields.
  </Card>
</Columns>
...
With the knowledge of how to pull records with new homeowner data, you will have the capability to contact and create lead data. You can also further enhance this data with reference to Datafiniti's people data as well.omeowner
