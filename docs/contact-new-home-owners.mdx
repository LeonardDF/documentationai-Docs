...
By using a range query on `yearBuilt`, we can find every property that was built no later than 2018.

The `yearBuilt` field represents the actual year the physical structure was constructed. This is particularly useful for identifying buildings, commercial residentials, and other non-apartment properties, as it allows you to directly determine when the property was originally built. By filtering on this field, you can separate established homes from new construction and target owners of older properties who may be more likely to need services such as renovations, roofing, or upgrades.
...
<Callout kind="info" collapsed="false">
  **Autotrace people data**
  ...
  For more information on our auto\_trace feature, you can read more about it here: [Autotrace](/docs/autotrace-property)
</Callout>
