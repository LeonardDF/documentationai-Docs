...
<Steps>
  <Step title="Provide a list of your clients' addresses" title-type="p">
    ...
    <Callout kind="info" collapsed="false">
      **Address normalization**
      ...
      Datafiniti uses standardized street name normalization. Converting `street` to `st`, `drive` to `dr`, etc, you can learn more about our [Normalized Property Addresses](/docs/normalized-address-data). If you wish to exactly match addresses to Datafiniti's property data, you will need to use this normalization method.
    </Callout>
  </Step>

  <Step title="Build a script that checks the current status of each address" title-type="p">
  ...
  <Step title="Use the updated client file to run a campaign" title-type="p">
