  ...
  <Step title="Provide a list of your clients' addresses" title-type="p">
    ...
    <Callout kind="tip" collapsed="false">
      **Address normalization**
      ...
      Datafiniti normalizes street designations to standardized abbreviations such as `st` for `street` and `dr` for `drive`. Use normalized address forms when you need exact matching against Datafiniti's property data. You can learn more in [Normalized Property Addresses](/docs/normalized-address-data).
    </Callout>
  </Step>
