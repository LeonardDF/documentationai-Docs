...
title: Fuzzy Match
description: >-
  Control how business address queries match stored records by using fuzzy
  matching, exact matching, or exact-then-fallback retry behavior.
---
...
<Columns cols="3">
  <Card title="Search via street address" href="/docs/search-via-street-address-business" icon="map-pin" horizontal="false">

  </Card>

  <Card title="Find local restaurants using geolocation" href="/docs/find-local-restaurants-using-geolocation" icon="map" horizontal="false">

  </Card>

  <Card title="Discover business revenue" href="/docs/discover-business-revenue" icon="bar-chart" horizontal="false">
