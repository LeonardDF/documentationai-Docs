...
| `total_cost`     | The total number of credits used by this download.  People records have a record cost multiplier tied to them.  [See pricing](https://www.datafiniti.co/data/people-data#pricing).                   |
