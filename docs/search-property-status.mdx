...
<Callout kind="info" collapsed>
  **Address normalization**

Datafiniti normalizes street designations to standardized abbreviations. For exact matching, use the normalized form of the address when searching Datafiniti property data. Learn more in [Normalized Property Addresses](/docs/normalized-address-data).
</Callout>
