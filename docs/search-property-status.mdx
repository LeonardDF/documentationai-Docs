...
<Callout kind="tip" collapsed="false">
  **Fuzzy Matching**
  ...
  For more details on how fuzzy matching and address normalization work, see <a href="/docs/normalized-address-data" target="_blank" rel="noopener noreferrer">Normalized Property Addresses</a>.
</Callout>
