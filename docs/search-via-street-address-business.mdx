...
<Callout kind="info" collapsed="false">
  **Street Name Abbreviations**
  ...
  Datafiniti runs an address normalization process across our entire business and business database. We normalize our addresses to a 2-character USPS standard abbreviation. You can find out more about this process, [Normalized Property Addresses](/docs/normalized-address-data).
</Callout>
