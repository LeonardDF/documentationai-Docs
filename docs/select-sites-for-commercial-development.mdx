...
If you need to search for properties that are in different statuses, use one of the [available values](https://docs.datafiniti.co/docs/create-save-a-custom-property-view) for `mostRecentStatus`.
