...
| Question                                                        | Answer                                                                                                                                                                                                                            |
| --------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| What is the format?                                             | See the <a href="https://docs.datafiniti.co/docs/constructing-people-queries" target="_blank" rel="noopener noreferrer">Constructing People Queries</a> guide for the complete field reference, operators, and advanced examples. |
...
<CodeGroup default-tab="3" show-lines="true" tabs={["Contact_info.py","people_count.py","people_full_query.py","people_paginate.py"]}>
