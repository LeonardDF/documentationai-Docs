...
<Callout kind="tip" collapsed="false">
  **Download size follows your plan**
  ...
  How many records a download can return is governed by your [subscription plan](https://portal.datafiniti.co/settings/billing/subscription). To page a smaller set by hand instead, `df_search` returns up to 50 records across calls.
</Callout>
