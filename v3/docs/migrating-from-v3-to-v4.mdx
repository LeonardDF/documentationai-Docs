...
<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452665109-76yy2coxnjq-0f7198e-auth_v3.jpg?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="V3 API authentication" />

Here's the same request in the V4 API:

<Image src="https://blob-cdn.documentation.ai/org-a829270c-4408-45aa-90cb-a8cad2967955/doc-82f0e261-4f6b-45af-9f00-b0b805bf07d2/1775452666164-r5al65frb9r-6860a81-auth_v4.jpg?fm=auto&auto=compress%2Cformat" width="1920" height="1080" alt="V4 API authentication" />
...
<CollectionContent node="versions:v4.0/tabs:Guides/groups:Datafiniti API" />
...
As a reminder, views specify which fields are returned in your search or download request and how those fields are formatted.  For example, the [products\_basicFields](/v3/docs/products_basicfields) view for product data only returns a subset of available product fields, while the [products\_pricesFlat](/v3/docs/products_pricesflat) view will split multiple prices for a single product into different rows when requesting CSV data.
